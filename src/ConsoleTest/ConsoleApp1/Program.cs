...
internal class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        // var res = await UserSeed.GetTokenTestUser();
        // System.Console.WriteLine("Success");
        // await UserSeed.FollowUser(res, "a2ee3128-b9d6-4226-99fc-37a97e77fe81");
        
        await Handler.HandlerMongo();
        // await HandlerRedis.Test();
    }
}
